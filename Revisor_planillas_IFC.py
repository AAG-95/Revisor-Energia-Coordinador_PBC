...
carpeta_salida=r'C:/Users/alonso.flores/Documents/Revisor2/'
...
pares_lista = func.generar_pares(primer_año, último_año, primer_mes_primer_año, último_mes_último_año)
...
for par in pares_lista:
    ...
    for file_name in file_list:
        ...
        # Intentar leer la hoja 'Formulario-Clientes R' si existe
        try:
    ...
    func.process_data(carpeta_salida, dataframes_libres_E, "Observaciones Clientes Libres", par)
    func.process_data(carpeta_salida, dataframes_libres_R, "Revisor Clientes Libres", par)
    func.process_data(carpeta_salida, dataframes_regulados_E, "Observaciones Clientes Regulados", par)
    func.process_data(carpeta_salida, dataframes_regulados_R, "Revisor Clientes Regulados", par)
