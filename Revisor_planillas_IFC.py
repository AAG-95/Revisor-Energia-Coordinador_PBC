...
try:
    ...
    for par in pares_lista:
        ...
        for file_name in file_list:
            ...
            df["Energía [kWh]"] = pd.to_numeric(df["Energía [kWh]"].astype(str).str.replace(",", "."), errors='coerce')
            ...
            df_Nvs["Energía [kWh]"] = df_Nvs["Energía [kWh]"].astype(str).str.replace('.', ',')   
            ...
            df_FCL_E["Cargo [$/kWh]"] = (
                df_FCL_E["Cargo [$/kWh]"].astype(str).str.replace(".", ",", regex=False)
            )

            df_FCL_E["Energía facturada [kWh]"] = (
                df_FCL_E["Energía facturada [kWh]"].astype(str).str.replace(".", ",",  regex=False)
            )

            df_FCL_E["Recaudación [$]"] = (
                df_FCL_E["Recaudación [$]"].astype(str).str.replace(".", ",", regex=False)
            )
            ...
            df_FCL_R["Observación"] = (
                df_FCL_R["Observación"].astype(str).str.replace(".", ",", regex=False)
            )
