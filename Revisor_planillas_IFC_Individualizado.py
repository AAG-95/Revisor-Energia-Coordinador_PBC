...
for par in pares_lista:
    ...
    for file_name in file_list:
        ...
        if nombre_empresa[0] in empresas_analizadas:
            ...
            # Verificar si el dataframe de dataframes no está vacío
