...
class ProcesadorRetirosHistoricos:
    def __init__(self, primer_año, primer_mes_primer_año, último_año, último_mes_último_año):
        ...
        self.pares_lista = fc.ConversionDatos().generar_pares(self.primer_año, self.último_año, self.primer_mes_primer_año, self.último_mes_último_año)
        self.pares_lista = fc.ConversionDatos().generar_pares(self.primer_año, self.último_año, self.primer_mes_primer_año, self.último_mes_último_año)
    ...
    def carga_informacion_historica(self):
        ...
        if os.path.isfile(
            self.ruta_balances_historicos_clientes_L + "\Retiros_Históricos_Clientes_L.csv"
        ):
        ...
        if os.path.isfile(
            self.ruta_balances_historicos_clientes_R + "\Retiros_Históricos_Clientes_R.csv"
        ):
